...
-- Insert rows into the EMP table
...
VALUES
  ...
  (7788, 'SCOTT', 'ANALYST', 7566, DATE_SUB(STR_TO_DATE('13-07-1987', '%d-%m-%Y'), INTERVAL 85 DAY), 3000, NULL, 20),
  ...
  (7876, 'ADAMS', 'CLERK', 7788, DATE_SUB(STR_TO_DATE('13-07-1987', '%d-%m-%Y'), INTERVAL 51 DAY), 1100, NULL, 20),
